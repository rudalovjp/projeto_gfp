...
const Estilos = {
    ...
    inputCadastro: 'w-full border border-gray-300 px-4 py-2 rounded-lg shadow-md focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500',
    ...
    iconeCorBotaoModal: 'w-10 h-10 rounded-full p-1 text-white flex items-center justify-center cursor-pointer hover:scale-110 transition-transform',
}
